...
<%@ page
	import="com.rahul.service.impl.*,com.rahul.service.*,com.rahul.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #E6F9E6;">
	...
	if (user == null)
		user = new UserBean("Test User", 950810862L, "test@gmail.com", "ABC colony, Patna, bihar", 87659, "lksdjf");
	%>
